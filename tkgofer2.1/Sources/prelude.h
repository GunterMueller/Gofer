...
#define SOLARIS  0      /* For Solaris, is same as SVR4                 UN */
#define GNUWIN32 0      /* Fo Windows95 and NT, using cygnuwin32           */

/* Arch is now SOLARIS -- Don't delete this line! */

#undef  SOLARIS
#define SOLARIS 1   /* Generated */
 ...
 *   SIGJMP         for using sigsetjmp instead of setjmp
 *-------------------------------------------------------------------------*/
...
#define TERMIO_IO	(LINUX  | HPUX | OS2 | SVR4 | SGI4 | GNUWIN32 )
...
#define SIGJMP          (GNUWIN32)

/* include the TkGofer sources */

#define TK_GOFER        1 /* For embedding Tk/Tcl                          */
...
#define NUM_TYCON          Pick(60,    160,        300)
#define NUM_NAME           Pick(625,   2000,       16000)
/* #define NUM_CLASSES        Pick(20,    40,         40)   */
#define NUM_CLASSES        Pick(20,    40,         80)         
#define NUM_INSTS          Pick(60,    100,        400)
#define NUM_INDEXES        Pick(700,   2000,       4000)
